...
public class MaceratorGUIGui extends ChemcraftModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/macerator_gui.png");
		@Override
