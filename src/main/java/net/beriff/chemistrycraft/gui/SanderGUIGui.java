...
public class SanderGUIGui extends ChemcraftModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public SanderGUIGui(ChemcraftModElements instance) {
		super(instance, 15);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/sander_gui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("chemcraft:textures/grinder_gui.png"));
