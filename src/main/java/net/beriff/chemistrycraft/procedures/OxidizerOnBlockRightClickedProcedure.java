...
public class OxidizerOnBlockRightClickedProcedure extends ChemcraftModElements.ModElement {
	public OxidizerOnBlockRightClickedProcedure(ChemcraftModElements instance) {
		super(instance, 33);
	}
