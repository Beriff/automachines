...
public class AlloyFurnaceOnBlockRightClickedProcedure extends ChemcraftModElements.ModElement {
	public AlloyFurnaceOnBlockRightClickedProcedure(ChemcraftModElements instance) {
		super(instance, 44);
	}
