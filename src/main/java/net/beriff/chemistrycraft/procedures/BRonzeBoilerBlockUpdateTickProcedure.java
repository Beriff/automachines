...
public class BRonzeBoilerBlockUpdateTickProcedure extends ChemcraftModElements.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Items.WATER_BUCKET, (int) (1)).getItem())) {
			if (!world.isRemote) {
				...
				if (_tileEntity != null)
					...
					}.getValue(new BlockPos((int) x, (int) y, (int) z), "water")) + 50));
		...
		if (((new Object() {
			...
			if (((new Object() {
			...
			}.getValue(new BlockPos((int) x, (int) y, (int) z), "water")) > 4)) {
				if (!world.isRemote) {
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					TileEntity _tileEntity = world.getTileEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
				...
				if (!world.isRemote) {
					...
					if (_tileEntity != null)
						...
						}.getValue(new BlockPos((int) x, (int) y, (int) z), "water")) - 5));
					world.notifyBlockUpdate(_bp, _bs, _bs, 3);
				}
				{
					TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
