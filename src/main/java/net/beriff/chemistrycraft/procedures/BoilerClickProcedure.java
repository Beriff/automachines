...
public class BoilerClickProcedure extends ChemcraftModElements.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure BoilerClick!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure BoilerClick!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure BoilerClick!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure BoilerClick!");
			return;
		}
