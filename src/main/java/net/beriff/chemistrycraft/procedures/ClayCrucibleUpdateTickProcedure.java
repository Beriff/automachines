...
import net.beriff.chemistrycraft.block.LimestoneBlock;
...
public class ClayCrucibleUpdateTickProcedure extends ChemcraftModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == Blocks.CAMPFIRE.getDefaultState().getBlock())
				|| ((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == LitFireboxBlock.block.getDefaultState()
						.getBlock()))) {
			if (((new Object() {
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(LimestoneBlock.block, (int) (1))
					.getItem())) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
					if (_ent != null) {
						final int _sltid = (int) (1);
						final ItemStack _setstack = new ItemStack(QuicklimeItem.block, (int) (1));
						_setstack.setCount((int) 1);
						_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
							if (capability instanceof IItemHandlerModifiable) {
								((IItemHandlerModifiable) capability).setStackInSlot(_sltid, _setstack);
