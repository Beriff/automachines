...
import net.beriff.chemistrycraft.item.OsmiumCrystalItem;
import net.beriff.chemistrycraft.item.IridiumPieceItem;
import net.beriff.chemistrycraft.ChemcraftModElements;

import java.util.concurrent.atomic.AtomicReference;

@ChemcraftModElements.ModElement.Tag
public class LeacherUpdateTickProcedure extends ChemcraftModElements.ModElement {
	public LeacherUpdateTickProcedure(ChemcraftModElements instance) {
		super(instance, 55);
	}
