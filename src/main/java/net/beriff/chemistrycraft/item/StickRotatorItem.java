...
import net.beriff.chemistrycraft.procedures.StickRotatorRightClickedOnBlockProcedure;
...
public class StickRotatorItem extends ChemcraftModElements.ModElement {
	...
	public StickRotatorItem(ChemcraftModElements instance) {
		super(instance, 96);
	}
