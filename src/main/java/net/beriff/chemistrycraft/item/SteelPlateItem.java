...
public class SteelPlateItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:steel_plate")
	public static final Item block = null;
	public SteelPlateItem(ChemcraftModElements instance) {
		super(instance, 228);
	}
