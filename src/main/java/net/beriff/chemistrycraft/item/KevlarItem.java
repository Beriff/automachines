...
public class KevlarItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:kevlar")
	public static final Item block = null;
	public KevlarItem(ChemcraftModElements instance) {
		super(instance, 312);
	}
