...
public class PlantFiberItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:plant_fiber")
	public static final Item block = null;
	public PlantFiberItem(ChemcraftModElements instance) {
		super(instance, 70);
	}
