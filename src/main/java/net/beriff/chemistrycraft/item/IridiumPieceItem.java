...
public class IridiumPieceItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:iridium_piece")
	public static final Item block = null;
	public IridiumPieceItem(ChemcraftModElements instance) {
		super(instance, 55);
	}
