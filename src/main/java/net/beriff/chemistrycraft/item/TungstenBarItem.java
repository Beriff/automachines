...
public class TungstenBarItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:tungsten_bar")
	public static final Item block = null;
	public TungstenBarItem(ChemcraftModElements instance) {
		super(instance, 264);
	}
