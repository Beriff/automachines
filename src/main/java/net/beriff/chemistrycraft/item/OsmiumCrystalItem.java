...
public class OsmiumCrystalItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:osmium_crystal")
	public static final Item block = null;
	public OsmiumCrystalItem(ChemcraftModElements instance) {
		super(instance, 54);
	}
