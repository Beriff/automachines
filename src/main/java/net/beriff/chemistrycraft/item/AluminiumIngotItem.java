...
public class AluminiumIngotItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:aluminium_ingot")
	public static final Item block = null;
	public AluminiumIngotItem(ChemcraftModElements instance) {
		super(instance, 28);
	}
