...
public class CopperDustItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:copper_dust")
	public static final Item block = null;
	public CopperDustItem(ChemcraftModElements instance) {
		super(instance, 131);
	}
