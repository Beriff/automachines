...
public class BronzeIngotItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:bronze_ingot")
	public static final Item block = null;
	public BronzeIngotItem(ChemcraftModElements instance) {
		super(instance, 133);
	}
