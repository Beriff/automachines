...
public class PlatinumIngotItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:platinum_ingot")
	public static final Item block = null;
	public PlatinumIngotItem(ChemcraftModElements instance) {
		super(instance, 50);
	}
