...
public class PlatinumGroupConcentrateItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:platinum_group_concentrate")
	public static final Item block = null;
	public PlatinumGroupConcentrateItem(ChemcraftModElements instance) {
		super(instance, 51);
	}
