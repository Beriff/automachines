...
public class MagnetitePieceItem extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:magnetite_piece")
	public static final Item block = null;
	public MagnetitePieceItem(ChemcraftModElements instance) {
		super(instance, 78);
	}
