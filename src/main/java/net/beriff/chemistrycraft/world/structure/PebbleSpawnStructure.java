...
public class PebbleSpawnStructure extends ChemcraftModElements.ModElement {
	public PebbleSpawnStructure(ChemcraftModElements instance) {
		super(instance, 114);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 70000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("chemcraft", "pebble2"));
						if (template == null)
							return false;
