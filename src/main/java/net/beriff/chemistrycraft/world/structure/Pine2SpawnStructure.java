...
public class Pine2SpawnStructure extends ChemcraftModElements.ModElement {
	public Pine2SpawnStructure(ChemcraftModElements instance) {
		super(instance, 112);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 50000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("chemcraft", "pine2"));
						if (template == null)
							return false;
