...
public class VolcanoLandsBiome extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:volcano_lands")
	public static final CustomBiome biome = null;
	public VolcanoLandsBiome(ChemcraftModElements instance) {
		super(instance, 12);
	}
