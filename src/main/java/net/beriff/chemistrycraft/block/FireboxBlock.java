...
import net.beriff.chemistrycraft.procedures.FireboxOnBlockRightClickedProcedure;
...
public class FireboxBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:firebox")
	public static final Block block = null;
	public FireboxBlock(ChemcraftModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				FireboxOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
