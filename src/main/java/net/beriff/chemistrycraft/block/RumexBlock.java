...
public class RumexBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:rumex")
	public static final Block block = null;
	public RumexBlock(ChemcraftModElements instance) {
		super(instance, 269);
	}
