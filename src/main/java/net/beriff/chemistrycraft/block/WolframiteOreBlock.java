...
public class WolframiteOreBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:wolframite_ore")
	public static final Block block = null;
	public WolframiteOreBlock(ChemcraftModElements instance) {
		super(instance, 249);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wolframite_ore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("wolframite_ore", "wolframite_ore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 12)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(6, 0, 0, 128))));
		}
	}
}
