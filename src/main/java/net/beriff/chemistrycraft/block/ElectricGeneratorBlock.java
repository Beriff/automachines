...
import net.beriff.chemistrycraft.procedures.ElectricGeneratorOnBlockRightClickedProcedure;
...
public class ElectricGeneratorBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:electric_generator")
	public static final Block block = null;
	@ObjectHolder("chemcraft:electric_generator")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ElectricGeneratorBlock(ChemcraftModElements instance) {
		super(instance, 139);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("electric_generator"));
	}
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				ElectricGeneratorOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("electric_generator");
		}
