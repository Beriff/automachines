...
public class PegmatiteBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:pegmatite")
	public static final Block block = null;
	public PegmatiteBlock(ChemcraftModElements instance) {
		super(instance, 179);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("pegmatite", "pegmatite", blockAt -> {
