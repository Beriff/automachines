...
public class PolishedGabbroBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:polished_gabbro")
	public static final Block block = null;
	public PolishedGabbroBlock(ChemcraftModElements instance) {
		super(instance, 182);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("polished_gabbro", "polished_gabbro", blockAt -> {
