...
public class PolishedAshBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:polished_ash")
	public static final Block block = null;
	public PolishedAshBlock(ChemcraftModElements instance) {
		super(instance, 25);
	}
