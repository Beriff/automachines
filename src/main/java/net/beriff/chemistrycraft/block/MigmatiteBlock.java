...
public class MigmatiteBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:migmatite")
	public static final Block block = null;
	public MigmatiteBlock(ChemcraftModElements instance) {
		super(instance, 177);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("migmatite", "migmatite", blockAt -> {
