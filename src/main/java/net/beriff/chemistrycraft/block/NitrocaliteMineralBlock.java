...
public class NitrocaliteMineralBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:nitrocalite_mineral")
	public static final Block block = null;
	public NitrocaliteMineralBlock(ChemcraftModElements instance) {
		super(instance, 42);
	}
