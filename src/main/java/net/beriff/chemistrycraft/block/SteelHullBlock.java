...
public class SteelHullBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:steel_hull")
	public static final Block block = null;
	public SteelHullBlock(ChemcraftModElements instance) {
		super(instance, 220);
	}
