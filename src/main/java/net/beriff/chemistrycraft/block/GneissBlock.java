...
public class GneissBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:gneiss")
	public static final Block block = null;
	public GneissBlock(ChemcraftModElements instance) {
		super(instance, 175);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 5)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(20, 0, 0, 128))));
		}
	}
}
