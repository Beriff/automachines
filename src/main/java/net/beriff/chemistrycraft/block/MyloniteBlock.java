...
public class MyloniteBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:mylonite")
	public static final Block block = null;
	public MyloniteBlock(ChemcraftModElements instance) {
		super(instance, 178);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("mylonite", "mylonite", blockAt -> {
