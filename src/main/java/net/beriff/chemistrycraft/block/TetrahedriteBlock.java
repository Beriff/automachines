...
public class TetrahedriteBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:tetrahedrite")
	public static final Block block = null;
	public TetrahedriteBlock(ChemcraftModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TetrahedriteOrePieceItem.block, (int) (2)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("tetrahedrite", "tetrahedrite", blockAt -> {
