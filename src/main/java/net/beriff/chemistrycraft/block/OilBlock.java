...
import net.beriff.chemistrycraft.procedures.OilMobplayerCollidesBlockProcedure;
...
public class OilBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:oil")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("chemcraft:oil_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public OilBlock(ChemcraftModElements instance) {
		super(instance, 226);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("chemcraft:blocks/oil"), new ResourceLocation("chemcraft:blocks/oil")).luminosity(0)
						.density(10000).viscosity(10000)).bucket(() -> bucket).block(() -> block);
		...
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ModTabItemGroup.tab))
