...
public class LimestoneBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:limestone")
	public static final Block block = null;
	public LimestoneBlock(ChemcraftModElements instance) {
		super(instance, 92);
	}
