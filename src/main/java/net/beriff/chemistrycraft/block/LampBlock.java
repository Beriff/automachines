...
import net.beriff.chemistrycraft.procedures.LampUpdateTickProcedure;
...
public class LampBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:lamp")
	public static final Block block = null;
	@ObjectHolder("chemcraft:lamp")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public LampBlock(ChemcraftModElements instance) {
		super(instance, 266);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("lamp"));
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				LampUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("lamp");
		}
