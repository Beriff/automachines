...
public class CopperCableBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:copper_cable")
	public static final Block block = null;
	public CopperCableBlock(ChemcraftModElements instance) {
		super(instance, 1);
	}
