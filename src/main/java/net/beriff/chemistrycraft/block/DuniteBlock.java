...
public class DuniteBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:dunite")
	public static final Block block = null;
	public DuniteBlock(ChemcraftModElements instance) {
		super(instance, 173);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("dunite", "dunite", blockAt -> {
