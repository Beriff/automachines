...
import net.beriff.chemistrycraft.procedures.WaterMillUpdateTickProcedure;
...
public class WaterMillBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:water_mill")
	public static final Block block = null;
	@ObjectHolder("chemcraft:water_mill")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public WaterMillBlock(ChemcraftModElements instance) {
		super(instance, 137);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("water_mill"));
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				WaterMillUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("water_mill");
		}
