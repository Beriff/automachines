...
public class TreeBranchBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:tree_branch")
	public static final Block block = null;
	public TreeBranchBlock(ChemcraftModElements instance) {
		super(instance, 60);
	}
