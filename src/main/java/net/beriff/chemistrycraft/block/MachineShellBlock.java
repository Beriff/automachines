...
public class MachineShellBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:machine_shell")
	public static final Block block = null;
	public MachineShellBlock(ChemcraftModElements instance) {
		super(instance, 5);
	}
