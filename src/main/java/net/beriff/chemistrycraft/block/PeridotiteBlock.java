...
public class PeridotiteBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:peridotite")
	public static final Block block = null;
	public PeridotiteBlock(ChemcraftModElements instance) {
		super(instance, 180);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("peridotite", "peridotite", blockAt -> {
