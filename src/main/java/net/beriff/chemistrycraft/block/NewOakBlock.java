...
import net.beriff.chemistrycraft.procedures.NewOakUpdateTickProcedure;
...
public class NewOakBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:new_oak")
	public static final Block block = null;
	public NewOakBlock(ChemcraftModElements instance) {
		super(instance, 61);
	}
