...
public class ScoriaBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:scoria")
	public static final Block block = null;
	public ScoriaBlock(ChemcraftModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.8999999999999999f, 10f).lightValue(0)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("scoria", "scoria", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				if (blockAt.getBlock() == PumiceOreBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
