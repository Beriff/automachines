...
public class SerpentiniteBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:serpentinite")
	public static final Block block = null;
	public SerpentiniteBlock(ChemcraftModElements instance) {
		super(instance, 186);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("serpentinite", "serpentinite", blockAt -> {
