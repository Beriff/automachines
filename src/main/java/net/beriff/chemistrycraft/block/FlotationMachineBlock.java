...
import net.beriff.chemistrycraft.procedures.FlotationMachineUpdateTickProcedure;
import net.beriff.chemistrycraft.procedures.FlotationMachineOnBlockRightClickedProcedure;
...
public class FlotationMachineBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:flotation_machine")
	public static final Block block = null;
	@ObjectHolder("chemcraft:flotation_machine")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public FlotationMachineBlock(ChemcraftModElements instance) {
		super(instance, 221);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("flotation_machine"));
	}
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("flotation_machine");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				FlotationMachineUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				FlotationMachineOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("flotation_machine");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Flotation Machine");
		}
