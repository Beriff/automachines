...
public class LigninBlock extends ChemcraftModElements.ModElement {
	@ObjectHolder("chemcraft:lignin")
	public static final Block block = null;
	public LigninBlock(ChemcraftModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LigninShardItem.block, (int) (2)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("lignin", "lignin", blockAt -> {
