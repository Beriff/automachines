...
public class PlantFiberItem extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:plant_fiber")
	public static final Item block = null;
	public PlantFiberItem(AutomachinesModElements instance) {
		super(instance, 70);
	}
