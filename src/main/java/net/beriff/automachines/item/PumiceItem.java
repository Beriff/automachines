...
public class PumiceItem extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:pumice")
	public static final Item block = null;
	public PumiceItem(AutomachinesModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("porous material"));
		}
	}
}
