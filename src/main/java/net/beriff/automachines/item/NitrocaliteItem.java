...
public class NitrocaliteItem extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:nitrocalite")
	public static final Item block = null;
	public NitrocaliteItem(AutomachinesModElements instance) {
		super(instance, 42);
	}
