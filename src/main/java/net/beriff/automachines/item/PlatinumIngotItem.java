...
public class PlatinumIngotItem extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:platinum_ingot")
	public static final Item block = null;
	public PlatinumIngotItem(AutomachinesModElements instance) {
		super(instance, 50);
	}
