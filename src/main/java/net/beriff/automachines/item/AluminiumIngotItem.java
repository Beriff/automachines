...
public class AluminiumIngotItem extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:aluminium_ingot")
	public static final Item block = null;
	public AluminiumIngotItem(AutomachinesModElements instance) {
		super(instance, 28);
	}
