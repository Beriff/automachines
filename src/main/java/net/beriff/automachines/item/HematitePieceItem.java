...
public class HematitePieceItem extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:hematite_piece")
	public static final Item block = null;
	public HematitePieceItem(AutomachinesModElements instance) {
		super(instance, 77);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hematite_piece");
		}
