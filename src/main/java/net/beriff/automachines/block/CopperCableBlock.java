...
public class CopperCableBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:copper_cable")
	public static final Block block = null;
	public CopperCableBlock(AutomachinesModElements instance) {
		super(instance, 1);
	}
