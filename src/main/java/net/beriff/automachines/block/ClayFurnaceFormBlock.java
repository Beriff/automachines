...
public class ClayFurnaceFormBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:clay_furnace_form")
	public static final Block block = null;
	public ClayFurnaceFormBlock(AutomachinesModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("clay_furnace_form");
		}
