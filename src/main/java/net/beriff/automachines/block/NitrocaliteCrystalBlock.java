...
public class NitrocaliteCrystalBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:nitrocalite_crystal")
	public static final Block block = null;
	public NitrocaliteCrystalBlock(AutomachinesModElements instance) {
		super(instance, 56);
	}
