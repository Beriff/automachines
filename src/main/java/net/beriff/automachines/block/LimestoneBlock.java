...
public class LimestoneBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:limestone")
	public static final Block block = null;
	public LimestoneBlock(AutomachinesModElements instance) {
		super(instance, 92);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 14)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(16, 0, 0, 128))));
		}
	}
}
