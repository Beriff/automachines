...
import net.beriff.automachines.procedures.NewOakUpdateTickProcedure;
...
public class NewOakBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:new_oak")
	public static final Block block = null;
	public NewOakBlock(AutomachinesModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				NewOakUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	}
