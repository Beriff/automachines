...
public class PolishedAshBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:polished_ash")
	public static final Block block = null;
	public PolishedAshBlock(AutomachinesModElements instance) {
		super(instance, 25);
	}
