...
public class TreeBranchBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:tree_branch")
	public static final Block block = null;
	public TreeBranchBlock(AutomachinesModElements instance) {
		super(instance, 60);
	}
