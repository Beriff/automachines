...
public class SulfurOreBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:sulfur_ore")
	public static final Block block = null;
	public SulfurOreBlock(AutomachinesModElements instance) {
		super(instance, 31);
	}
