...
public class AluminiumOreBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:aluminium_ore")
	public static final Block block = null;
	public AluminiumOreBlock(AutomachinesModElements instance) {
		super(instance, 27);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 18)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(7, 0, 0, 64))));
		}
	}
}
