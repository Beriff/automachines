...
public class AshBlockBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:ash_block")
	public static final Block block = null;
	public AshBlockBlock(AutomachinesModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AshItem.block, (int) (4)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("ash_block", "ash_block", blockAt -> {
