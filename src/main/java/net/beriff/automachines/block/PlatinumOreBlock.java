...
public class PlatinumOreBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:platinum_ore")
	public static final Block block = null;
	public PlatinumOreBlock(AutomachinesModElements instance) {
		super(instance, 52);
	}
