...
public class MachineShellBlock extends AutomachinesModElements.ModElement {
	@ObjectHolder("automachines:machine_shell")
	public static final Block block = null;
	public MachineShellBlock(AutomachinesModElements instance) {
		super(instance, 5);
	}
