...
import net.beriff.automachines.gui.ConcentratorGUIGui;
import net.beriff.automachines.AutomachinesModElements;

import io.netty.buffer.Unpooled;

@AutomachinesModElements.ModElement.Tag
public class ConcentratorOnBlockRightClickedProcedure extends AutomachinesModElements.ModElement {
	public ConcentratorOnBlockRightClickedProcedure(AutomachinesModElements instance) {
		super(instance, 49);
	}
