...
public class LeacherOnBlockRightClickedProcedure extends AutomachinesModElements.ModElement {
	public LeacherOnBlockRightClickedProcedure(AutomachinesModElements instance) {
		super(instance, 41);
	}
