...
import net.beriff.automachines.block.PebbleBlock;
import net.beriff.automachines.AutomachinesModElements;

@AutomachinesModElements.ModElement.Tag
public class PebbleOnBlockRightClickedProcedure extends AutomachinesModElements.ModElement {
	public PebbleOnBlockRightClickedProcedure(AutomachinesModElements instance) {
		super(instance, 69);
	}
