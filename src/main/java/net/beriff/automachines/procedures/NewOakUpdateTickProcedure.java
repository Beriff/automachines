...
import net.beriff.automachines.block.TreeBranchBlock;
import net.beriff.automachines.AutomachinesModElements;

@AutomachinesModElements.ModElement.Tag
public class NewOakUpdateTickProcedure extends AutomachinesModElements.ModElement {
	public NewOakUpdateTickProcedure(AutomachinesModElements instance) {
		super(instance, 62);
	}
